...
export default function About() {
  ...
  return (
    <section className="min-h-screen flex items-center py-16 lg:py-24 relative" id="about">
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.2 }}
        transition={{ duration: 1.5 }}
        className="absolute w-100 min-h-screen bg-indigo-500/20 -left-50 blur-3xl rounded-full"
      ></motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            <motion.div 
              ...
              className="absolute bg-slate-200 size-15 left-20 top-40 md:size-20 md:left-10 md:rounded-3xl rounded-2xl"
            ></motion.div>
            <motion.div 
              custom={1}
              variants={imageShapeVariants}
              whileHover={{ rotate: -10, scale: 1.05 }}
              className="absolute bg-slate-200 size-25 left-30 -bottom-5 md:left-25 md:bottom-10 md:size-25 rounded-3xl"
            ></motion.div>
            <motion.div 
              custom={0.5}
              variants={imageShapeVariants}
            ...
            <motion.div 
              ...
              className="absolute bg-slate-200 size-35 right-30 -bottom-10 sm:right-15 sm:bottom-0 sm:size-40 rounded-3xl"
            ></motion.div>
          </motion.div>
          ...
          <motion.div 
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="w-full lg:w-1/2 text-left text-white space-y-6"
          >
